...
import com.bhavesh16281.cards.DTO.ResponseDto;
import com.bhavesh16281.cards.service.CardsService;
...
public class CardsController {
    ...
    @GetMapping("/fetch")
    public ResponseEntity<CardsDto> fetchCardDetails(@RequestHeader("MBBank-correlation-id") String correlationId, @RequestParam
                                                     @Pattern(regexp="(^$|[0-9]{10})",message = "Mobile number must be 10 digits")
                                                     String mobileNumber) {
        logger.info("Fetching card details for mobile number: {}", mobileNumber);
